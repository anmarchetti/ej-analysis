...
export interface IPaymentFailureItem {
    code: string;
...
export const failuresConfig = [
    ...
    /** Apple Pay Errors */
    // waiting for a correct code
    {
        messageKey: SitecoreDictionary.PaymentFailureMessagesApplePayMerchantValidation,
        descriptionKey: SitecoreDictionary.PaymentFailureMessagesApplePayMerchantValidationDescriptionHTML,
        isFatal: true,
