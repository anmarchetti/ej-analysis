...
const SelectBoardTypeError = ({ errorMessage }: ISelectBoardTypeErrorProps) => (
    <div className='board-and-room__error'>
        <div className='px-4 py-2 row board-and-room__error__label my-2'>
            <svg
                ...
                viewBox='0 0 512 512'
                className='svg-inline--fa fa-exclamation-circle fa-w-16 fa-5x'
            >
                <path
                    fill='currentColor'
...
export default SelectBoardTypeError;
