...
namespace easyJet.Feature.SitecoreEnhancment.Pipelines.GetFieldSerializer
{
    ...
    public class GetRenderingMappingFieldSerializer : BaseGetFieldSerializer
    {
        public GetRenderingMappingFieldSerializer(IFieldRenderer fieldRenderer)
        : base(fieldRenderer)
        {
        }
        ...
        protected override void SetResult(GetFieldSerializerPipelineArgs args)
        {
            ...
            args.Result = new RenderingMappingFieldSerializer(FieldRenderer);
        }
    }
}
