...
{
    public class ForceRepublishTreeCurrentLanguageCommandTests
    {
        ...
        private readonly ForceRepublishTreeCurrentLanguageCommandProxy command;

        public ForceRepublishTreeCurrentLanguageCommandTests()
        {
            ...
            command = new ForceRepublishTreeCurrentLanguageCommandProxy(forceRepublishService, logger, databaseProvider, userCreationService, sitecoreUiService);
        }
        ...
        private class ForceRepublishTreeCurrentLanguageCommandProxy : ForceRepublishTreeCurrentLanguageCommand
        {
            public ForceRepublishTreeCurrentLanguageCommandProxy(
