...
{
    public class WhenContactBookingHasSpecificHotelTheme : ICondition, IContactSearchQueryFactory
    {
        ...
        public bool Evaluate(IRuleExecutionContext context)
        {
            ...
            return bookings != null && bookings.Any(booking => Comparison.Evaluate(booking.Theme, HotelTheme));
        }

        public Expression<Func<Contact, bool>> CreateContactSearchQuery(IContactSearchQueryContext context)
        {
            return contact =>
                contact.GetFacet<BookingsFacet>(BookingsFacet.DefaultFacetKey).Bookings.Values.Any(booking => Comparison.Evaluate(booking.Theme, HotelTheme));
        }
    }
}