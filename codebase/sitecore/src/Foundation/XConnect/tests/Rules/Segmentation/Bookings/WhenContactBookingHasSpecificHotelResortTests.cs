...
{
    public class WhenContactBookingHasSpecificHotelResortTests
    {
        private readonly IRuleExecutionContext ruleExecutionContext;
        private readonly WhenContactBookingHasSpecificHotelResort predicate;

        public WhenContactBookingHasSpecificHotelResortTests()
        {
            ruleExecutionContext = Substitute.For<IRuleExecutionContext>();
            predicate = new WhenContactBookingHasSpecificHotelResort();
        }
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfBookingsIsEmpty(Contact contact, string resort)
        {
            // Arrange
            predicate.HotelResort = resort;
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeTrue_IfHasSpecificHotelResort(Contact contact, string resort)
        {
            // Arrange
            predicate.HotelResort = resort;
            ...
            {
                Accommodation = new Accommodation() { Resort = resort }
            };
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfHasNoSpecificHotelResort(Contact contact)
        {
            // Arrange
            predicate.HotelResort = "Res01";

            var booking = new Booking()
            {
                Accommodation = new Accommodation() { Region = "Res02" }
            };
