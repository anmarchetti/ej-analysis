...
{
    public class WhenContactBookingHasSpecificHotelThemeTests
    {
        private readonly IRuleExecutionContext ruleExecutionContext;
        private readonly WhenContactBookingHasSpecificHotelTheme predicate;

        public WhenContactBookingHasSpecificHotelThemeTests()
        {
            ruleExecutionContext = Substitute.For<IRuleExecutionContext>();
            predicate = new WhenContactBookingHasSpecificHotelTheme();
        }
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfBookingsIsEmpty(Contact contact, string theme)
        {
            // Arrange
            predicate.HotelTheme = theme;
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeTrue_IfHasSpecificHotelTheme(Contact contact, string theme)
        {
            // Arrange
            predicate.HotelTheme = theme;
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfHasNoSpecificHotelTheme(Contact contact)
        {
            // Arrange
            predicate.HotelTheme = "Theme01";
