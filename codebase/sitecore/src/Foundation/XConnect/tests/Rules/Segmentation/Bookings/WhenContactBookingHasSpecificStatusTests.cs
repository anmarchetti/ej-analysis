...
{
    public class WhenContactBookingHasSpecificStatusTests
    {
        private readonly IRuleExecutionContext ruleExecutionContext;
        private readonly WhenContactBookingHasSpecificStatus predicate;

        public WhenContactBookingHasSpecificStatusTests()
        {
            ruleExecutionContext = Substitute.For<IRuleExecutionContext>();
            predicate = new WhenContactBookingHasSpecificStatus();
        }
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfBookingsIsEmpty(Contact contact, string status)
        {
            // Arrange
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeTrue_IfHasSpecificStatus(Contact contact, string status)
        {
            // Arrange
            predicate.Status = status;
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfHasNoSpecificStatus(Contact contact)
        {
            // Arrange
