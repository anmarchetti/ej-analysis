...
{
    public class WhenContactBookingHasFlightFromSpecificLocationTests
    {
        private readonly IRuleExecutionContext ruleExecutionContext;
        private readonly WhenContactBookingHasFlightFromSpecificLocation predicate;

        public WhenContactBookingHasFlightFromSpecificLocationTests()
        {
            ruleExecutionContext = Substitute.For<IRuleExecutionContext>();
            predicate = new WhenContactBookingHasFlightFromSpecificLocation();
        }
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfBookingsIsEmpty(Contact contact, string location)
        {
            // Arrange
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeTrue_IfHasFlightFromSpecificLocation(Contact contact, string location)
        {
            // Arrange
            predicate.Location = location;
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfHasNoFlightFromSpecificLocation(Contact contact)
        {
            // Arrange
            predicate.Location = "Location 1";
            var booking = new Booking()
            {
                Flights = new List<Flight>()
                {
