...
{
    public class WhenContactBookingHasFlightWithTransfersTests
    {
        private readonly IRuleExecutionContext ruleExecutionContext;
        private readonly WhenContactBookingHasFlightWithTransfers predicate;

        public WhenContactBookingHasFlightWithTransfersTests()
        {
            ruleExecutionContext = Substitute.For<IRuleExecutionContext>();
            predicate = new WhenContactBookingHasFlightWithTransfers();
        }
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeTrue_IfHasFlightWithTransfers(Contact contact, List<string> transfers)
        {
            // Arrange
        ...
        [Theory]
        [AutoData]
        public void Evaluate_ShouldBeFalse_IfHasNoFlightWithTransfers(Contact contact)
        {
            // Arrange
            var booking = new Booking()
            {
