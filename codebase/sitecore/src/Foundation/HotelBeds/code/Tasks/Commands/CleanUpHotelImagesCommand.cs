...
{
    /// <summary>
    /// Command that runs HotelBedsImagesResyncPipeline.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class CleanUpHotelImagesCommand
    {
        /// <summary>
        ...
        {
            CorePipeline.Run("HotelBedsImagesResyncPipeline", new DestinationPipelineArgs() { Parent = items.FirstOrDefault() });
        }
    }
}