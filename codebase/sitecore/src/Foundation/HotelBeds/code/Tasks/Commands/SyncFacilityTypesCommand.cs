...
{
    /// <summary>
    /// Command that runs HotelBedsFacilityTypesSynciPeline.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class SyncFacilityTypesCommand
    {
        /// <summary>
        /// Sync Facility Groups and Facilities from Hotel Beds.
        /// </summary>
        ...
        {
            CorePipeline.Run("HotelBedsFacilityTypesSyncPipeline", new DestinationPipelineArgs() { Parent = items.FirstOrDefault(), LastUpdateTime = schedule.LastRun });
        }
    }
}