...
namespace easyJet.Foundation.HotelBeds.Tasks.Commands
{
    ...
    public class SyncRoomsCommand
    {
        ...
        {
            CorePipeline.Run("HotelBedsRoomsSyncPipeline", new DestinationPipelineArgs() { Parent = items.FirstOrDefault(), LastUpdateTime = schedule.LastRun });
        }
    }
}