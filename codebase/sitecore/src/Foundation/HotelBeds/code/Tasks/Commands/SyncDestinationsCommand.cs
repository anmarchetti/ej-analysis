...
{
    /// <summary>
    /// Command that runs HotelBedsDestinationsUpdateSyncPipeline.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class SyncDestinationsCommand
    {
        /// <summary>
        /// Updates current Hotels with Data from Hotel Beds.
        /// </summary>
        ...
        {
            CorePipeline.Run("HotelBedsDestinationsUpdateSyncPipeline", new DestinationPipelineArgs() { Parent = items.FirstOrDefault(), LastUpdateTime = schedule.LastRun });
        }
    }
}