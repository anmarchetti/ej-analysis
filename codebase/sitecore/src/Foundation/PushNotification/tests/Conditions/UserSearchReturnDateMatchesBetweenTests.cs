...
{
    public class UserSearchReturnDateMatchesBetweenTests
    {
        private readonly IRuleExecutionContext ruleExecutionContext;
        private readonly UserSearchReturnDateMatchesBetween predicate;

        public UserSearchReturnDateMatchesBetweenTests()
        {
            ruleExecutionContext = Substitute.For<IRuleExecutionContext>();
            predicate = new UserSearchReturnDateMatchesBetween();
        }
        ...
        public void Evaluate_ShouldBeTrue_IfDepartureDateIsBetweenMinAndMaxDate(Contact contact)
        {
            ...
            userSearch.Searches.Add(new UserSearch() { EndDate = new DateTime(2022, 02, 06) });
