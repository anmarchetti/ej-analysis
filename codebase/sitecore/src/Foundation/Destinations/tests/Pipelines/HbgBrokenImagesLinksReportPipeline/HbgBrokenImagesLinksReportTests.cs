...
using easyJet.Foundation.Destinations.Pipelines.HbgBrokenImagesLinksReport;
...
namespace easyJet.Foundation.Destinations.Tests.Pipelines.HbgBrokenImagesLinksReportPipeline
{
    public class HbgBrokenImagesLinksReportTests
    {
        ...
        public HbgBrokenImagesLinksReportTests()
        {
        ...
        {
            // Arrange
            var sut = new HbgBrokenImagesLinksReportProxy(databaseProvider, destinationsRepository, logger, datasourceRepository, settings, mediaManager, imagesService);

            // Act
            var result = sut.ReportNameProxy;

            // Assert
            result.Should().StartWith("BrokenImagesLinksReport_HBG");
        }
        ...
        [InlineData("https://photos.hotelbeds.com/giata/bigger/23/230739/230739a_hb_p_003.jpg")]
        [InlineData("https://photos.hotelbeds.com/giata/xl/23/230739/230739a_hb_p_003.jpg")]
        public void FilterImageByType_ShouldReturnTrue_IfImagesStartWithHbgPrefix(string imageUrl)
        {
            // Arrange
            settings.GetSetting(Constants.BrokenLinksReport.ImageSizeSmallPrefixUrlSettingsName).Returns(HbgImagePrefix);
            var sut = new HbgBrokenImagesLinksReportProxy(databaseProvider, destinationsRepository, logger, datasourceRepository, settings, mediaManager, imagesService);
        ...
        [InlineData("https://easyjet-holidays-images-prod.s3-eu-west-1.amazonaws.com/hbg/18692/medium/img.jpg")]
        [InlineData("https://easyjet-holidays-images-prod.s3-eu-west-1.amazonaws.com/hbg/18692/large/img.jpg")]
        public void FilterImageByType_ShouldReturnTrue_ForHbgS3Urls(string imageUrl)
        {
            // Arrange
            settings.GetSetting(Constants.BrokenLinksReport.ImageSizeSmallPrefixUrlSettingsName).Returns(HbgImagePrefix);
            settings.GetSetting(Constants.BrokenLinksReport.HbgS3KeyPrefixSettingName, "hbg").Returns("hbg");
        ...
        [InlineData("https://easyjet-holidays-images-prod.s3-eu-west-1.amazonaws.com/3234_-_IBEROSTAR_Playa_Gaviotas/medium/3234_01.jpg")]
        [InlineData("https://easyjet-holidays-images-prod.s3-eu-west-1.amazonaws.com/3234_-_IBEROSTAR_Playa_Gaviotas/large/3234_01.jpg")]
        public void FilterImageByType_ShouldReturnFalse_IfImagesDoNotStartWithHbgPrefix(string imageUrl)
        {
            // Arrange
            settings.GetSetting(Constants.BrokenLinksReport.ImageSizeSmallPrefixUrlSettingsName).Returns(HbgImagePrefix);
            var sut = new HbgBrokenImagesLinksReportProxy(databaseProvider, destinationsRepository, logger, datasourceRepository, settings, mediaManager, imagesService);
        ...
        public void FilterImageItems_ShouldReturnFalse_IfImagesDoNotStartWithHbgPrefix(string imageUrl, string fieldName)
        {
            // Arrange
        ...
        public class HbgBrokenImagesLinksReportProxy : HbgBrokenImagesLinksReport
        {
            public HbgBrokenImagesLinksReportProxy(
