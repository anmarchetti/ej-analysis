...
namespace easyJet.Foundation.Atcom.Commands
{
    public class RunRoomTypesSyncCommand : BaseItemProgressReportingCommand
    {
        ...
        {
            return context.Items[0].TemplateID.Equals(Constants.TemplateIds.AtcomRoomTypesGroup);
        }

        /// <inheritdoc />
        protected override IEnumerable<Item> ProcessItems(Item contextItem)
        {
            return service.SyncRoomTypes(Constants.TemplateIds.RoomType, contextItem);
        }
    }
}