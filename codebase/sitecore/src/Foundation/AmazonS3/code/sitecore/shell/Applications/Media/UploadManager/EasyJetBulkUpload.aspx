<%@ Page AutoEventWireup="true" CodeBehind="EasyJetBulkUpload.aspx.cs" Inherits="easyJet.Foundation.AmazonS3.sitecore.shell.Applications.Media.UploadManager.EasyJetBulkUpload" Language="C#" %>
    ...
    <input id="ErrorText" runat="server" type="hidden" value="" />
          ...
          <tr>
            ...
            <td valign="top" width="100%">
              ...
              <div id="FileListWrapper">
                <sc:Literal runat="server" ID="DescIdFilename" Text="Select the files to upload here:" Style="font-size:14px;"/>
                <div id="FileList">
                    <input id="File0" name="File0" type="file" aria-labelledby="DescIdFilename" value="browse" onchange="javascript:return Sitecore.Upload.change(this)"/>
                </div>
              </div>
        ...
        <div id="OptionTableWrapper">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td>
                  <span>&nbsp;&nbsp;</span><input id="Unpack" name="Unpack" type="checkbox" value="1" /><label for="Unpack"><sc:Literal runat="server" Text="Unpack ZIP archives"></sc:Literal></label>
                </td>
                <td>
              ...
              <tr>
                <td runat="server" id="OverwriteCell">
                  <span>&nbsp;&nbsp;</span><input runat="server" id="Overwrite" name="Overwrite" type="checkbox" value="1" /><label for="Overwrite"><sc:Literal runat="server" Text="Overwrite existing media items"></sc:Literal></label>
                </td>
                <td>
                  <span>&nbsp;&nbsp;</span><input runat="server" id="KeepOriginal" name="KeepOriginal" type="checkbox" value="1" /><label for="KeepOriginal"><sc:Literal runat="server" Text="Keep original"></sc:Literal></label>
                </td>
              </tr>
            </table>
