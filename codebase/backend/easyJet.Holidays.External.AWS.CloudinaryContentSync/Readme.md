...
Execute unit tests
```
    cd "easyJet.Holidays.External.AWS.CloudinaryContentSync/test/easyJet.Holidays.External.AWS.CloudinaryContentSync.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "easyJet.Holidays.External.AWS.CloudinaryContentSync/src/easyJet.Holidays.External.AWS.CloudinaryContentSync"
