...
{
    public class BookingServiceCancelBookingFailureTests : IDisposable
    {
        ...
        public BookingServiceCancelBookingFailureTests()
        {
            ...
            _fixture.Inject(languageSettings);
            ...
            _fixture.Register<IBookingRepository>(() => new BookingRepository(
                ...
                _fixture.Create<ITransliterationService>(),
    ...
    <p2:Bkg_Type_Mth>TO</p2:Bkg_Type_Mth>
            ...
            atcomApiClient
                ...
                .ReturnsAsync((new MemoryStream(Encoding.UTF8.GetBytes(@"<p1:ErrorResponse xmlns:p1=""AtComRes/ErrorResponse"" xmlns:p2=""AtComRes/Common"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xsi:schemaLocation=""AtComRes/ErrorResponse ../api/ErrorResponse/ErrorResponse.xsd"">
                    <p2:Adm Debug=""false"" Xsd_Ver=""T3.20.4.8"">
                        ...
                        <p2:Trk From=""musyk"" To=""atcomres"" />
                        <p2:Ser_Msg>
                            <p2:Severity>ERROR</p2:Severity>
                            <p2:Code>E1204</p2:Code>
                            <p2:Desc>Unrecognised request</p2:Desc>
                        </p2:Ser_Msg>
                    </p2:Adm>
                </p1:ErrorResponse>"))));
        ...
        [Fact]
        public async Task MakePayment_Failure_CardDetails_CancelBooking_Failure()
        {
            // Arrange
            ...
            catch (ApiException aex)
            {
                ...
                //aex.InnerErrors[1].Code.Should().Be("E1204");
                //aex.InnerErrors[1].Message.Should().Be("Unrecognised request");
            }
        }
    }
}
