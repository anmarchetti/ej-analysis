...
{
    public class BookingServiceCommitBookingFailureTests : IDisposable
    {
        ...
        public BookingServiceCommitBookingFailureTests()
        {
            ...
            _fixture.Register<IApiService>(() => _fixture.Create<AtcomApiService>());
            ...
            _referenceDataServiceMock.Setup(service => service.GetSpecialRequestSettings()).ReturnsAsync(
            ...
            _referenceDataServiceMock.Setup(x => x.GetLuggage()).ReturnsAsync(new Luggage
            {
            ...
            _fixture.Register<IBookingRepository>(() => new BookingRepository(
                ...
                _fixture.Freeze<ILuggageService>(),
            ...
            _fixture.Register<IBookingSpecialRequestService>(() => new BookingSpecialRequestService(
                _fixture.Create<IBookingRepository>(),

                _referenceDataServiceMock.Object,
                 _fixture.Freeze<IOptions<AtcomSettings>>(),
                 _fixture.Freeze<IOptions<ApiSettings>>(),
                 _fixture.Freeze<ILogger<BookingSpecialRequestService>>(),
                _fixture.Freeze<ISpecialRequestValidator>()
            ));
            ...
            _fixture.Register(() => marketServiceMock.Object);
    ...
    <p2:Bkg_Type_Mth>TO</p2:Bkg_Type_Mth>
            ...
            atcomApiClient
                .Setup(x => x.MakeCall(
                    It.IsAny<HttpMethod>(),
                    It.Is<Uri>(u => u.AbsoluteUri.Contains("/EZYDMO/VRPWebservice/AniteGateway/AniteGateway.aspx")),
                    It.Is<string>(p => p.Contains("p2:ModifyCustPaymentRequest")),
                    It.IsAny<string>(),
                    It.IsAny<TimeSpan?>()))
                .ReturnsAsync(new MemoryStream(Encoding.UTF8.GetBytes(@"<p1:ErrorResponse xmlns:p1=""AtComRes/ErrorResponse"" xmlns:p2=""AtComRes/Common"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xsi:schemaLocation=""AtComRes/ErrorResponse ../api/ErrorResponse/ErrorResponse.xsd"">
                    <p2:Adm Debug=""false"" Xsd_Ver=""T3.20.4.8"">
                        <p2:Tm>2019-09-18T14:43:10+01:00</p2:Tm>
                        <p2:Trk From=""easyjet"" To=""atcomres"" />
                        <p2:Ser_Msg>
                            <p2:Severity>ERROR</p2:Severity>
                            <p2:Code>E12345</p2:Code>
                            <p2:Desc>I will never commit booking</p2:Desc>
                        </p2:Ser_Msg>
                    </p2:Adm>
                </p1:ErrorResponse>")));
        ...
        [Fact]
        public async Task MakePayment_OK_Commit_Failed_CancelBooking_OK_CancelPayment_OK()
        {
            ...
            #region Cancel Payment mock

            eiApiClient
                .Setup(x => x.MakeCall(It.IsAny<HttpMethod>(), It.Is<Uri>(u => u.AbsoluteUri.Contains("/core/finance/payments/v1/cancel-payment-request")), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TimeSpan?>()))
                .ReturnsAsync(new MemoryStream(Encoding.UTF8.GetBytes(@"{
                    ""paymentId"": ""1884932""
                }")));
            ...
            {
                // Assert #1
                aex.InnerErrors.Should().HaveCount(1);
                aex.InnerErrors[0].Code.Should().Be("E12345");
                aex.InnerErrors[0].Message.Should().Be("I will never commit booking");
            }

            // Assert #2
            atcomApiClient.Verify(x => x.MakeCall(It.Is<HttpMethod>(h => h.Method.ToUpperInvariant() == "POST"), It.Is<Uri>(u => u.AbsoluteUri.Contains("/EZYDMO/VRPWebservice/AniteGateway/AniteGateway.aspx")), It.Is<string>(p => p.Contains("p2:CancellationRequest")), It.IsAny<string>(), It.IsAny<TimeSpan?>()), Times.Once);
            eiApiClient.Verify(x => x.MakeCall(It.Is<HttpMethod>(h => h.Method.ToUpperInvariant() == "PUT"), It.Is<Uri>(u => u.AbsoluteUri.Contains("/core/finance/payments/v1/cancel-payment-request")), It.Is<string>(p => p.Contains("\"paymentId\":\"1884932\"")), It.IsAny<string>(), It.IsAny<TimeSpan?>()), Times.Once);
        }

        [Fact]
        public async Task MakePayment_OK_Commit_Failed_CancelBooking_Failed_CancelPayment_OK()
        {
            ...
            atcomApiClient
                ...
                .ReturnsAsync((new MemoryStream(Encoding.UTF8.GetBytes(@"<p1:ErrorResponse xmlns:p1=""AtComRes/ErrorResponse"" xmlns:p2=""AtComRes/Common"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xsi:schemaLocation=""AtComRes/ErrorResponse ../api/ErrorResponse/ErrorResponse.xsd"">
                    <p2:Adm Debug=""false"" Xsd_Ver=""T3.20.4.8"">
                        ...
                        <p2:Ser_Msg>
                            <p2:Severity>ERROR</p2:Severity>
                            <p2:Code>E7890</p2:Code>
                            <p2:Desc>Can not cancel booking</p2:Desc>
                        </p2:Ser_Msg>
                    </p2:Adm>
                </p1:ErrorResponse>"))));
            ...
            {
                // Assert #1
                aex.InnerErrors.Should().HaveCount(2);
                aex.InnerErrors[0].Code.Should().Be("E12345");
                aex.InnerErrors[0].Message.Should().Be("I will never commit booking");
                aex.InnerErrors[1].Code.Should().Be("E7890");
                aex.InnerErrors[1].Message.Should().Be("Can not cancel booking");
            }
        ...
        [Fact]
        public async Task MakePayment_OK_Commit_Failed_CancelBooking_Failed_CancelPayment_Failed()
        {
            ...
            eiApiClient
                ...
                .ReturnsAsync(new MemoryStream(Encoding.UTF8.GetBytes(@"{
                    ""errors"": [
                        {
                            ""code"": ""SVC_PAY_100021_3001"",
                            ""message"": ""Error in Payments System"",
                            ""affectedData"": [
                                {
                                    ""dataName"": ""11"",
                                    ""information"": ""Payment Not Found""
                                }
                            ]
                        }
                    ]
            ...
            {
                // Assert #1
                aex.InnerErrors.Should().HaveCount(3);
                aex.InnerErrors[0].Code.Should().Be("E12345");
                aex.InnerErrors[0].Message.Should().Be("I will never commit booking");
                aex.InnerErrors[1].Code.Should().Be("11");
                aex.InnerErrors[1].Message.Should().Be("Payment Not Found");
                aex.InnerErrors[2].Code.Should().Be("E7890");
                aex.InnerErrors[2].Message.Should().Be("Can not cancel booking");
            }
        ...
        [Fact]
        public async Task MakePayment_OK_AddSpecialRequest_Failed__CancelBooking_OK_CancelPayment_OK()
        {
            #region CancelBooking mock
            ...
            atcomApiClient
               .Setup(x => x.MakeCall(It.IsAny<HttpMethod>(), It.Is<Uri>(u => u.AbsoluteUri.Contains("/EZYDMO/VRPWebservice/AniteGateway/AniteGateway.aspx")), It.Is<string>(p => p.Contains("p2:ModifyMemoRequest")), It.IsAny<string>(), It.IsAny<TimeSpan?>()))
               .ReturnsAsync(new MemoryStream(Encoding.UTF8.GetBytes(@"<p1:ModifyMemoResponse xmlns:p1=""AtComRes/ModifyMemoResponse"" xmlns:p2=""AtComRes/Common"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xsi:schemaLocation=""AtComRes/ModifyMemoResponse ../api/ModifyMemoResponse/ModifyMemoResponse.xsd"">
                   <p2:Adm Xsd_Ver = ""TE3.20.6.0"">
                        <p2:Tm> 2021 - 01 - 25T08: 14:51.484 + 00:00 </p2:Tm>
                         <p2:Trk From=""easyjet"" To=""atcomres""/>
                        <p2:Ser_Msg>
                            <p2:Severity>ERROR</p2:Severity>
                            <p2:Code>E10759</p2:Code>
                            <p2:Desc>Memo Code is invalid</p2:Desc>
                            <p2:KeyValuePair Key = ""K1"">BLAX</p2:KeyValuePair>
                        </p2:Ser_Msg>
                    </p2:Adm>
                    <p2:CltInfo>
                        <p2:Locale>en_EN</p2:Locale>
                    ...
                    <p2:BkgNum>
                        <p2:BkgId>2018812</p2:BkgId>
                    </p2:BkgNum>
                </p1:ModifyMemoResponse> ")));
            ...
            catch (ApiException aex)
            {
                // Assert #1
                aex.InnerErrors.Should().HaveCount(1);
                aex.InnerErrors[0].Code.Should().Be("E10759");
                aex.InnerErrors[0].Message.Should().Be("Memo Code is invalid");
            }
