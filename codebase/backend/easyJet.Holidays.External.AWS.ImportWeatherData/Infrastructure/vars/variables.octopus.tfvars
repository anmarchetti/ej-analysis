...
dynamo_db_deletion_protection_enabled = "#{Aws.DynamoDb.DeletionProtectionEnabled}"

# Environment variables
lambda_env = {
  regions_file_path = "#{Lambda.Env.RegionsFilePath}"
  weather_file_path = "#{Lambda.Env.WeatherFilePath}"
}
