...
{
    [Fact]
    public void BookingRequestPaymentInfoNull_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
        ...
        // Act
        var bookingRequest = JsonConvert.DeserializeObject<BookingRequest>(json);

        // Assert
        Assert.NotNull(bookingRequest);
        bookingRequest.PaymentInfo.Should().BeNull();
    }
    
    [Fact]
    public void BookingRequestPaymentInfoEmpty_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
        ...
        // Assert
        Assert.NotNull(bookingRequest);
        bookingRequest.PaymentInfo.Should().NotBeNull();
        bookingRequest.PaymentInfo.ValidateByDefaultValue().Should().BeFalse();
    }
    
    [Fact]
    public void BookingRequestCardPaymentInfo_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
        ...
        var paymentInfo = bookingRequest.PaymentInfo;
        paymentInfo.Should().BeOfType<CardPaymentInfo>();
        bookingRequest.PaymentInfo.ValidateByDefaultValue().Should().BeTrue();
    ...
    [Fact]
    public void BookingRequestApplePayPaymentInfo_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
