...
{
    [Fact]
    public void AmendBookingRequestPaymentInfoNull_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
        ...
        // Act
        var amendBookingRequest = JsonConvert.DeserializeObject<AmendBookingRequest>(json);

        // Assert
        Assert.NotNull(amendBookingRequest);
        amendBookingRequest.PaymentInfo.Should().BeNull();
    }
    
    [Fact]
    public void AmendBookingRequestPaymentInfoEmpty_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
        ...
        // Assert
        Assert.NotNull(amendBookingRequest);
        amendBookingRequest.PaymentInfo.Should().NotBeNull();
        amendBookingRequest.PaymentInfo.ValidateByDefaultValue().Should().BeFalse();
    }
    
    [Fact]
    public void AmendBookingRequestCardPaymentInfo_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
        ...
        var paymentInfo = amendBookingRequest.PaymentInfo;
        paymentInfo.Should().BeOfType<CardPaymentInfo>();
        amendBookingRequest.PaymentInfo.ValidateByDefaultValue().Should().BeTrue();
    ...
    [Fact]
    public void AmendBookingRequestApplePayPaymentInfo_ShouldDeserializeFromJson()
    {
        // Arrange
        const string json = """
        {
    ...
    [Fact]
    public void BookingRequestInvalidPaymentInfo_ShouldThrowException()
    {
        // Arrange
        const string json = """
        {
        ...
        // Act & Assert
        InvalidPaymentTypeException exception = Assert.Throws<InvalidPaymentTypeException>( () => JsonConvert.DeserializeObject<BookingRequest>(json));
